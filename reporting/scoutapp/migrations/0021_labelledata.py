...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('scoutapp', '0020_delete_labelledata'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Adult', models.IntegerField(default=' ', max_length=64, blank=True)),
                ('Eggs', models.IntegerField(default=' ', max_length=64, blank=True)),
                ('Tapped', models.IntegerField(default=' ', max_length=64, blank=True)),
                ('Flush', models.IntegerField(default=' ', max_length=64, blank=True)),
