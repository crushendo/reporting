...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('scoutapp', '0024_delete_labelledata'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date', models.CharField(default=' ', max_length=64, blank=True)),
                ...
                ('Tapped', models.IntegerField(null=True, blank=True)),
                ('Flush', models.IntegerField(null=True, blank=True)),
